    ...
    <>
      <section ref={inputRef}>
        ...
        <div className="flex flex-row justify-center">
          <div className="flex flex-col m-5 max-w-sm" style={{ width: 384 }}>
            ...
            <p className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-2 h-16" style={{ borderBottomColor: "#EE2B7B" }}><b>Descripción:</b> {sample.descripcion} </p>
          </div>
